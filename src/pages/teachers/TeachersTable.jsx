...
export default function TeachersTable({
  ...
  const toggleEditDropdown = (teacherId) => {
    setSelectedTeacherId((prevTeacherId) =>
      prevTeacherId === teacherId ? null : teacherId
    );
  };

  const handleClickOutside = (event, teacherId) => {
    const dropdown = dropdownRefs.current[teacherId];
  ...
  useEffect(() => {
    const handleOutsideClick = (event) => {
      handleClickOutside(event, selectedTeacherId);
    };
                      ...
                      <tr
                        ...
                        <td className="px-4 py-3 flex items-center justify-end">
                          <button
                            ...
                            type="button"
                            onClick={() => toggleEditDropdown(teacher.id)}
                            ref={(el) =>
                          ...
                          <div className="absolute z-50">
                            <div
                              id={`teacher-dropdown-${teacher.id}`}
                              className={`${
